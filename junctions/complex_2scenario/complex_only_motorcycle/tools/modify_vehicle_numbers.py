...
def modify_vehicle_numbers(xml_file, output_file, default_num, acceleration_num, deceleration_num, lcSpeedGain_num, lcPushy_num, 
                           lcStrategic_num, lcCooperative_num, mingap_num, lcAssertive_num):
    """
    Modify the number of vehicles in each <flow> tag of an XML file based on function arguments.
        'names': ['default', 'acceleration', 'deceleration', 'lcSpeedGain', 'lcPushy', 'lcStrategic', 'lcCooperative', 'mingap', 'jmDriveAfterYellowTime'],
    ...
    # }
    new_numbers = {
        "acceleration": acceleration_num,
        "deceleration": deceleration_num,
        "minGap": mingap_num,
        "lcSpeedGain": lcSpeedGain_num,
        "lcCooperative": lcCooperative_num,
        "lcPushy": lcPushy_num,
        "lcStrategic": lcStrategic_num,
        "lcAssertive": lcAssertive_num
    }
...
modify_vehicle_numbers(input_xml, output_xml,  acceleration_num=120, 
                       deceleration_num=100, lcSpeedGain_num=80, lcPushy_num=40, 
                       lcStrategic_num=350, lcCooperative_num=60, 
                       mingap_num=80, lcAssertive_num=90)
