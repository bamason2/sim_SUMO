...
def modify_vehicle_numbers(xml_file, output_file, pkw_num, bus_num,scooter_num, truck_num):
    """
    ...
    #     "aggressive": aggressive_num,
    #     "jumpystyle": jumpystyle_num,
    #     "chaotic": chaotic_num
    # }

    colors = {"pkw": "#1f77b4", "bus": "#ff7f0e", "scooter": "#2ca02c", "truck": "#d62728"}
...
modify_vehicle_numbers(input_xml, output_xml, pkw_num=50, bus_num=120, truck_num=40, scooter_num=350)
